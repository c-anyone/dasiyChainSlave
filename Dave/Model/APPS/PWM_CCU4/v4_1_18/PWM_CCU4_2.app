...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_CCU4" URI="http://resources/4.1.18/app/PWM_CCU4/2" description="PWM APP using one timer slice of CCU4, with external events support, to generate a PWM output." mode="NOTSHARABLE" version="4.1.18" minDaveVersion="4.0.0" instanceLabel="PWM_CCU4_2" appLabel="" containingProxySignal="true">
  <properties provideInit="true"/>
  <virtualSignals name="CCU4_global_signal" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_global_signal" hwSignal="global_signal" hwResource="//@hwResources.0"/>
  <virtualSignals name="event_cmp_match" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_compare_match_interrupt" hwSignal="cmds_cmus" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="event_period_match" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_period_match_interrupt" hwSignal="pmus_omds" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="event_0" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_event0_interrupt" hwSignal="e0as" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="event_1" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_event1_interrupt" hwSignal="e1as" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="event_2" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_event2_interrupt" hwSignal="e2as" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="timer_st" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_st" hwSignal="st" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="pwm_output" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_channel_out_signal" hwSignal="out" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="ext_event0" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_gp0_unsync" hwSignal="gp0_unsync" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="ext_event1" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_gp1_unsync" hwSignal="gp1_unsync" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="ext_event2" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_gp2_unsync" hwSignal="gp2_unsync" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="gp0" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_gp0" hwSignal="gp0" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="gp1" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_gp1" hwSignal="gp1" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="gp2" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_gp2" hwSignal="gp2" hwResource="//@hwResources.0" visible="true"/>
  ...
  <connections URI="http://resources/4.1.18/app/PWM_CCU4/2/http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_channel_out_signal/http://resources/4.0.14/app/DIGITAL_IO/5/vs_digital_io_pad_pin" sourceSignal="pwm_output" targetSignal="pin" srcVirtualSignal="//@virtualSignals.7">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../DIGITAL_IO/v4_0_14/DIGITAL_IO_5.app#//@virtualSignals.1"/>
    <targetVirtualSignal href="../../DIGITAL_IO/v4_0_14/DIGITAL_IO_5.app#//@virtualSignals.1"/>
  </connections>
</ResourceModel:App>
